...
var firstDivH1Txt = document.createTextNode("ID")
...
var secondDivH1Txt = document.createTextNode("Name")
...
var thirdDivH1Txt = document.createTextNode("User Name")
...
for (var key in data){
    ...
    var firstDivPTxt = document.createTextNode(data[key].id)

    var secondDivP = document.createElement("p");
    secondDivP.setAttribute("class", "cd")
    var secondDivPTxt = document.createTextNode(data[key].name)

    var thirdDivP = document.createElement("p");
    thirdDivP.setAttribute("class", "contad")
    var thirdDivPTxt = document.createTextNode(data[key].username)
 
    var fourthDivP = document.createElement("a");
    fourthDivP.setAttribute("onClick", `details(${data[key].id})`)
...
function details(el) {
  modalDivMain.style.display="block"
    ...
    for (var key in data){
      ...
      if(data[key].id === el) {
          console.log(data[key].name)
           modalDetailDiv.innerHTML ="<h3>  ID: " +  data[key].id  + "</h3>" +
            "<h3>  EMAIL: " +  data[key].email  + "</h3>" + "<h2> Address: </h2>" +
          "<h4>"+ "Street : " + data[key].address.street  +"</h4>" +  "<h4>" +
          "Suite : " + data[key].address.suite +"</h4>" + 
          "<h4> City : " + data[key].address.city  +"</h4>" + "<h4> Zip-Code : " + data[key].address.zipcode  +"</h4>"
          + "<h2> Geo: </h2>" +  "<h4> Latitude : " + data[key].address.geo.lat  +"</h4>" +
          "<h4> Langitude : " + data[key].address.geo.lng  +"</h4>" +   "<h4> Phone: " + data[key].phone  +"</h4>" +
          "<h4> Website : " + data[key].website  +"</h4>" + "<h2> Company: </h2>" +
          "<h4> Name : " + data[key].company.name  +"</h4>" +  "<h4> Catch Phrase : " + data[key].company.catchPhrase  +"</h4>" +
          "<h4> BS : " + data[key].company.bs  +"</h4>"

      }
      console.log(data[key].address.suite)
